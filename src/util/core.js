...
export default {
    ...
    worker: function() {
        return new Worker('static/lib/wsocket.js');
    },
    init: function(mw, cw) {
        self._ws0 = mw;
        self._ws1 = cw;
    ...
    text_translate: function(json, locale, speech) {
        json.locale = locale;
        if (json.language == json.locale) {
            this.text_append(json, speech);
        } else {
            // translate
    ...
    text_append: function(json, speech) {
        if (speech) {
